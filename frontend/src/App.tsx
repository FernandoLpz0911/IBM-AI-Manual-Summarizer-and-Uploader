...
export default function App() {
  ...
  const handleUpload = (file: File) => {
    ...
    const newDoc: DocumentData = {
      ...
      content: [
        "Content extraction pending... In a real app, OCR would run here.",
        ...
        MOCK_CHATS[doc.id] || [
          {
            id: "init",
            sender: "ai",
            text: `Ready to discuss ${doc.title}. I've analyzed the content.`,
          },
        ]
      );
    } else {
      setMessages([
        {
          id: "init",
          sender: "ai",
          text: `Viewing Public Document: ${doc.title}.`,
        },
      ]);
    }
    setView("doc-read");
  ...
  return (
    <div
      className={`min-h-screen ${styles.bgGradient} transition-colors duration-500 font-sans`}
    >
      <Navbar
