 ...
 * AUTH SCREEN
 */
const AuthScreen = ({ onLogin, onNavigateToRegister, loading }: { onLogin: (e: React.FormEvent) => void, onNavigateToRegister: () => void, loading: boolean }) => (
      ...
      <div className="bg-white/10 backdrop-blur-lg border border-white/10 rounded-xl shadow-2xl p-8 w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        <form onSubmit={onLogin} className="space-y-4">
          <div>
            ...
            <input required type="email" className="mt-1 w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-white outline-none placeholder-slate-400 transition" placeholder="demo@example.com" />
          </div>
          <div>
 ...
 * REGISTER SCREEN
 */
const RegisterScreen = ({ onRegister, onNavigateToLogin, loading }: { onRegister: (e: React.FormEvent) => void, onNavigateToLogin: () => void, loading: boolean }) => (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4 relative overflow-hidden">
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/40 via-slate-900 to-black"></div>
      ...
      <div className="bg-white/10 backdrop-blur-lg border border-white/10 rounded-xl shadow-2xl p-8 w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        <form onSubmit={onRegister} className="space-y-4">
          <div>
            ...
            <input required type="text" className="mt-1 w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-white outline-none placeholder-slate-400 transition" placeholder="John Doe" />
          </div>
          <div>
            <label className="block text-sm font-medium text-blue-100">Email</label>
            <input required type="email" className="mt-1 w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-white outline-none placeholder-slate-400 transition" placeholder="demo@example.com" />
          ...
          <div className="grid grid-cols-2 gap-4">
             ...
             <div>
              <label className="block text-sm font-medium text-blue-100">Confirm</label>
              <input required type="password" className="mt-1 w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 text-white outline-none placeholder-slate-400 transition" placeholder="••••••" />
            </div>
          </div>
...
export default function App() {
  ...
  const [view, setView] = useState<'login' | 'register' | 'dashboard' | 'library' | 'community' | 'group-chat' | 'upload' | 'doc-read' | 'doc-chat' | 'support'>('login');
